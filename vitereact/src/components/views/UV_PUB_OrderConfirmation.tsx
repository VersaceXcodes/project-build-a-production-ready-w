...
const UV_PUB_OrderConfirmation: React.FC = () => {
  ...
  const hasSuccessfulPayment = payments.some(p => p.status === 'COMPLETED');
  ...
  // If order is pending payment, redirect back to checkout or show pending message
      ...
      <div className="min-h-screen bg-gray-50 py-8 lg:py-16">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Payment Pending</h1>
            <p className="text-lg text-gray-600">
              This order has not been paid yet. Please complete your payment to confirm the order.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-8">
            <div className="bg-yellow-50 px-6 py-4 border-b">
              <div className="flex items-center gap-2">
                ...
                <span className="text-yellow-700 font-medium">Payment Required</span>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 text-sm">
                Your order has been created but payment was not completed. Please return to checkout to complete your purchase.
              </p>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gray-50 py-8 lg:py-16">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-8">
          ...
          {/* Status Badge - Only show success if actually paid */}
